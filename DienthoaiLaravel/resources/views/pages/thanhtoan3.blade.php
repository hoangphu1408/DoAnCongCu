            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 clearfix" id="checkout">
                        ...
                        <div class="box">
                            <form method="post" action="{{URL::to('/thanh-toan-4')}}">
                                {{csrf_field()}}
                                        ...
                                        <div class="col-sm-6">
                                            <div class="box shipping-method">
                                                ...
                                                <div class="box-footer text-center">
                                                    ...
                                                    <input type="radio" name="pttt" value="chuyenkhoan" checked> Chuyển khoản
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="box shipping-method">
                                                ...
                                                <div class="box-footer text-center">
                                                    ...
                                                    <input type="radio" name="pttt" value="tienmat"> Trả tiền mặt khi nhận hàng
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="box-footer">
                                    <div class="pull-left">
                                       <a href="{{URL::to('/thanh-toan-2')}}" class="btn btn-default"><i class="fa fa-chevron-left"></i>Quay lại bước 2</a>
                                    </div>
