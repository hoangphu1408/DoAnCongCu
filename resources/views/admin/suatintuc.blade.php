...
<div class="row clearfix">
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" style="margin:auto; float:none">
                    <div class="card">
                        ...
                        @foreach ($suatin as $key => $suatin)
                        <div class="body">
                            <form id="form_validation" method="POST" action="{{URL::to('/cap-nhat-tin-tuc/'.$suatin -> Id_tin)}}">
                            	{{csrf_field()}}
                                
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="tieude" required minlength="10"  placeholder="Tiêu đề tin" value="{{$suatin -> tieude}}"> 
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="tieude_khongdau" placeholder="Tiêu đề không dấu" value="{{$suatin -> tieude_khongdau}}">
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea name="tomtat" cols="30" rows="5" class="form-control no-resize" placeholder="Tóm tắt" >{{$suatin -> tomtat}}</textarea>
                                    </div>
                                </div>
                                
                                <div class="form-group form-float"> 
                                    <div class="form-line">
                                    <input type="file" name="url_hinh" id="urlHinh" class="form-control"  placeholder="Địa chỉ hình của tin" >
                                    </div> 
                                </div>
                                ...
                                <div class="row cleafix">
                                    <div class="col-md-6">
                                       <div class="form-group form-float">
                                       <input type="radio" id="AH1" name="anhien" <?=($suatin -> anhien == 1)?' checked':''?> value="1"> 
                                       <label for="AH1">Hiện</label>
                                           <input type="radio" id="AH0" name="anhien" <?=($suatin -> anhien == 0)?' checked':''?> value="0">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group form-float">
                                          <input type="radio" id="vi" name="ngonngu" <?=($suatin -> ngonngu == 'vi')?' checked':''?> value="vi"> 
                                            <label for="vi">Tiếng Việt</label>
                                            <input type="radio" id="en" name="ngonngu" <?=($suatin -> ngonngu == 'en')?' checked':''?> value="en">
                                ...
                                <div class="row cleafix">
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                            <input class="form-control" name="tags" placeholder="Tags" value="{{$suatin -> tags}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                        <div class="form-line">
                                        <input type="text" class="datepicker form-control" name="ngay" placeholder="Xin chọn ngày" value="{{$suatin -> ngay}}">
                                        </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                       <textarea id="editor1" name="noidung" cols="30" rows="10" class="form-control" required placeholder="Nội dung tin">{{$suatin -> noidung}}</textarea>
                                    </div>
                                </div>
                                <div class="row cleafix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> <div class="form-line">
                                    ...
                                    <select name="Id_hang" class="form-control show-tick" id="Id_hang">
                                        ...
                                        @foreach ($hang as $key => $hang)
                                            @if($hang -> Id_hang == $suatin -> Id_hang)
                                ...
                                <button class="btn btn-primary waves-effect" type="submit" name="them">Cập nhật tin</button>
