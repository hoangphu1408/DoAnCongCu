                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p>idTin: {{$tintuc -> Id_tin}}</p>
                                                <p><?=date('d/m/Y',strtotime($tintuc -> ngay))?></p>
                                                
                                            </td>
                                            <td>
                                                <h4>{{$tintuc -> tieude}}  <span>( {{$tintuc -> tenhang}} / 
                                                    {{$tintuc -> tags}})</span></h4>
                                                <p>{{$tintuc -> tomtat}}</p>
                                            </td>
                                            <td width="120">
                                                <p>
                                                 <a href="{{URL::to('/sua-tin-tuc/'.$tintuc -> Id_tin)}}" class=" btn bg-blue waves-effect" >Cập nhật</a> &nbsp;
                                                <a href="{{URL::to('/xoa-tin-tuc/'.$tintuc -> Id_tin)}}" onClick="return confirm('Chắc chắn chứ')" class=" btn bg-red waves-effect" >Xóa</a>
                                                </p>
                                                <p><?=($tintuc -> anhien == 1)?"Đang hiện":"Đang ẩn"?> </p>  
                                                <p><?=($tintuc -> ngonngu == 'vi')?"Tiếng Việt":"Tiếng Anh"?></p> 
                                                </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
